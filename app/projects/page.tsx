...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Projects | Our Work Showcase  ",
    description:
    ...
    <main className="main py-10 md:py-16">
      ...
      >
        ...
        <div className="space-y-4">
          <Heading as="h1" title="Projects" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold capitalize text-gray-900">
            Our Work Showcase
          </h2>
          <p className="text-gray-600 text-base md:text-lg max-w-2xl">
            Explore our portfolio of innovative projects and digital solutions
        ...
        {!hasProjects ? (
          <div className="flex flex-col items-center justify-center py-16 md:py-24 px-4">
            ...
            <p className="text-gray-600 text-center max-w-md mb-8">
              We&#39;re currently updating our portfolio. Check back soon to see
              our latest work and innovative solutions.
            </p>
